...
As per the data [desription](https://github.com/Md-Khid/Civil_Conflict_And_Food_Aid/blob/main/FoodAid.xlsx), some variables represent combined totals of distinct variables. Hence, it's crucial to consider:
